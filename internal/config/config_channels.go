...
type BrowserToolConfig struct {
	...
	PinchTabURL     string `json:"pinchtab_url,omitempty"`      // PinchTab server URL, e.g. "http://localhost:9867"; when set, PinchTab is used instead of go-rod
	PinchTabToken   string `json:"pinchtab_token,omitempty"`    // Bearer token for PinchTab API authentication
